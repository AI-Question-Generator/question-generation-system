...
mcq_prompt.system = Template('\n'.join([
  ...
  "Generate multiple choice vocabulary questions that test applying these synonyms / antonyms in context, rather than just recalling definitions.",
  ...
  "- Test memory and well understanding of synonyms, antonyms, collocations.",
